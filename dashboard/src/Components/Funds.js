    ...
    <div className="funds-page">
      <div className="funds-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>Instant, zero-cost fund transfers powered by UPI.</p>
        </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
              <div>
                ...
                <h3 className="stat-value" style={{ color: 'var(--success)' }}>₹{balance.toLocaleString("en-IN")}</h3>
              </div>
              <div style={{ textAlign: 'right' }}>
                <p className="stat-label">Available Cash</p>
                <p style={{ fontSize: '1.25rem', fontWeight: '700', margin: '4px 0' }}>₹{balance.toLocaleString("en-IN")}</p>
              </div>
            </div>
            ...
            <div style={{ padding: '20px', background: 'var(--bg-main)', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-light)' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', paddingTop: '12px', borderTop: '1px solid var(--border)' }}>
                ...
                <p style={{ fontWeight: '600' }}>₹{balance.toLocaleString("en-IN")}</p>
              </div>
            </div>
          </div>
        </div>

        <div className="section" style={{ background: 'var(--bg-main)', borderStyle: 'dashed', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
          <div style={{ padding: '32px' }}>
            <p className="section-title" style={{ marginBottom: '16px' }}>Commodity</p>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginBottom: '24px' }}>You don't have a commodity account active at the moment.</p>
